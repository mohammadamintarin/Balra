    ...
    <div class="container mx-auto max-w-screen-xl">
        ...
        <div class="grid grid-cols-12 gap-4 leading-8">
            <div class="col-span-12 lg:col-span-5">
                ...
                <div class="mt-3">
                    <a href="#" class="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full ml-1 hover:text-yellow-500 hover:border-yellow-500 duration-200">
                    ...
                    <a href="#" class="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-yellow-500 hover:border-yellow-500 duration-200">
