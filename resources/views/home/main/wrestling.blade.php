...
{{--                    <img src="/home/image/icon/fire.gif" alt="لباس کشتی" class="w-8 lg:w-12 pl-2">--}}
                    <h3 class="text-gray-700 lg:text-3xl text-xl">لباس کشتی</h3>
                </div>
                <div class="flex items-center gap-x-3 text-gray-400 lg:text-xl text-sm">
                    <a href="/category/wrestling-clothes">مشاهده همه</a>
                    <svg class="w-5 h-5">
            ...
            <div id="owl-wrestling" class="owl-carousel owl-theme">
                @foreach($wrestlings as $item)
