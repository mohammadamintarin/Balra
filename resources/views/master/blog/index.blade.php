...
@section('content')
    ...
    <div class="statistics flex mx-auto justify-between items-center bg-statistics w-[90%] h-25 my-6 p-8 shadow">
        ...
        <div><a class="btn btn-success" href="{{route('master.blog.create')}}">افزودن دسته‌بندی جدید</a></div>
    </div>
                    ...
                    @foreach($blogs as $item)
                        <tr class="item{{$item->id}}">
                            ...
                            <td class="flex items-center justify-center gap-x-3 text-gray-300">
                                ...
                                <a class="group relative inline-block px-3" href="{{route('master.blog.edit' , ['blog' => $item->id])}}">
