        ...
        <div class="container">
            <div class="bg-white shadow border border-gray-100 dark:bg-zinc-500 w-[90%] mx-auto data_more_less">
                <div class="header flex justify-between items-center border-b border-gray-200 p-5 px-10">
                    <div class="text-2xl">
                        ویرایش {{$permission->display_name}}
                    </div>
                    <div>
                        <svg class="w-7 h-7"><use href="#permission"></use></svg>
                    </div>
                </div>
                <form action="{{route('master.permission.update' , ['permission' => $permission->id])}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="body p-4 py-9">
                        ...
                        <div class=" grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="display_name" value="{{$permission->display_name}}" required>
                            </div>
                        </div>
                    </div>
