    ...
    <section class="mb-52">
        <div class="container">
            <div class="bg-white shadow border border-gray-100 dark:bg-zinc-500 w-[90%] mx-auto data_more_less">
                ...
                <form action="{{route('master.type.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="body p-4 py-9">
                        ...
                        <div class=" grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="title" value="قیمت و خرید مدل " required>
                            </div>
                            <div class="sm:col-span-2">
                                <label>توضیحات سئو</label>
                                <input type="text" name="description" value="لیست قیمت  مدل و خرید با کیفیت بالا و ضمانت سلامت کالا  در فروشگاه اینترنتی  سمور با ارسال به سراسر ایران">
                            </div>
                            <div class="sm:col-span-2">
